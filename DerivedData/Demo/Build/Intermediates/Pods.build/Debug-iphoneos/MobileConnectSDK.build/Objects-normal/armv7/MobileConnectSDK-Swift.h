...
- (nonnull instancetype)initWithDiscoveryResponse:(DiscoveryResponse * _Nonnull)discoveryResponse assuranceLevel:(enum MCLevelOfAssurance)assuranceLevel context:(NSString * _Nonnull)context bindingMessage:(NSString * _Nullable)bindingMessage authorizationScopes:(NSArray<NSString *> * _Nonnull)authorizationScopes;
@end
